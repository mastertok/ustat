    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['course', '-updated_at'], name='courses_cou_course__1ab6ab_idx'), models.Index(fields=['-views_count'], name='courses_cou_views_c_fc2fe5_idx'), models.Index(fields=['-average_rating'], name='courses_cou_average_4c0621_idx'), models.Index(fields=['-revenue'], name='courses_cou_revenue_0c2055_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='course',
        ...
        migrations.AddIndex(
            model_name='course',
            index=models.Index(fields=['-students_count'], name='courses_cou_student_64ab03_idx'),
        ),
        migrations.AddIndex(
            model_name='course',
            index=models.Index(fields=['type', 'status'], name='courses_cou_type_733155_idx'),
        ),
        migrations.AddIndex(
            model_name='category',
